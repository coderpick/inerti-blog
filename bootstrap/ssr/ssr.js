...
const appName = "InertiaBlog";
createInertiaApp({
  title: (title) => `${title} - ${appName}`,
  resolve: (name) => resolvePageComponent(
    `./Pages/${name}.vue`,
    /* @__PURE__ */ Object.assign({ "./Pages/Index.vue": () => import("./assets/Index-16482f8b.js"), "./Pages/Show.vue": () => import("./assets/Show-1baf176e.js") })
  ),
  setup({ el, app: app2, props, plugin }) {
    return createApp({ render: () => h$1(app2, props) }).use(plugin).use(P, Ziggy).mount(el);
  }
});
