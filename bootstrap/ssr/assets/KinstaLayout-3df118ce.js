...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><header class="bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-700 w-full text-center py-4"><h1 class="text-white font-bold text-4xl">Coderpick Blog</h1></header><main class="container mx-auto text-center">`);
